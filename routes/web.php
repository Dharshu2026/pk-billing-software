...
Route::get('/shop/order', [App\Http\Controllers\OrderController::class, 'create'])->name('shop.order.create');
Route::post('/shop/order', [App\Http\Controllers\OrderController::class, 'store'])->name('shop.order.store');
/*
|--------------------------------------------------------------------------
